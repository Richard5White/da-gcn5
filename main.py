...
if __name__ == '__main__':
    ...
    parser.add_argument('--contrast_temp', type=float, default=0.16, help='对比损失温度参数')
    # 在train.py或参数解析的地方
    #parser.add_argument('--emb_dim', type=int, default=64, help='Dimension of user/item embeddings')
